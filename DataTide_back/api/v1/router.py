...
from DataTide_back.api.v1.endpoints import (
...
api_router.include_router(rag_router.router, prefix="/api")
api_router.include_router(analysis_router.router, prefix="/api")
